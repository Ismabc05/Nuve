...
export class Initial1788946147825 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Crear ENUM de roles de usuario antes de crear la tabla users
    await queryRunner.query(`
            CREATE TYPE "public"."users_role_enum"
            AS ENUM('user', 'admin')
        `);

    // Crear ENUM de estados de pedido antes de crear la tabla orders
    await queryRunner.query(`
            CREATE TYPE "public"."orders_status_enum"
            AS ENUM(
                'active',
                'pending',
                'paid',
    ...
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_8b0be371d28245da6e4f4b61878" UNIQUE ("name"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "product-images" ("id" SERIAL NOT NULL, "url" character varying(200) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "productId" integer NOT NULL, CONSTRAINT "PK_d8a34eb9070e1dc64180c287deb" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "brands" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_96db6bbbaa6f23cad26871339b6" UNIQUE ("name"), CONSTRAINT "PK_b0c437120b624da1034a81fc561" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "price" numeric(10,2) NOT NULL, "description" character varying(300) NOT NULL, "reviews" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "brandId" integer NOT NULL, CONSTRAINT "UQ_4c9fb58de893725258746385e16" UNIQUE ("name"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "product-variants" ("id" SERIAL NOT NULL, "size" character varying(50) NOT NULL, "color" character varying(50) NOT NULL, "stock" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "productId" integer NOT NULL, CONSTRAINT "UQ_4e3804fd0962c5edbedc2247c23" UNIQUE ("productId", "size", "color"), CONSTRAINT "PK_eefbe9ed1230ceced1653d29ddd" PRIMARY KEY ("id"))`,
    );

    await queryRunner.query(
      `CREATE TABLE "order-items" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "unitPrice" numeric(10,2) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "orderId" integer NOT NULL, "productvariantId" integer NOT NULL, CONSTRAINT "PK_605fbaee38242facaa1a34b67ad" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "product-images" ADD CONSTRAINT "FK_e1706dd0f5669c2054d9442cace" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "product-variants" ADD CONSTRAINT "FK_c67ecf80ca357fcf820f7ab0e47" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    await queryRunner.query(
      `ALTER TABLE "order-items" ADD CONSTRAINT "FK_d42918a88740ece11347e20918f" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );

    await queryRunner.query(
      `ALTER TABLE "order-items" ADD CONSTRAINT "FK_66e2e31fa579f7922a0e7e5b743" FOREIGN KEY ("productvariantId") REFERENCES "product-variants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order-items" DROP CONSTRAINT "FK_66e2e31fa579f7922a0e7e5b743"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "product-variants" DROP CONSTRAINT "FK_c67ecf80ca357fcf820f7ab0e47"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "product-images" DROP CONSTRAINT "FK_e1706dd0f5669c2054d9442cace"`,
    );
    ...
    // Eliminar los ENUM después de eliminar las tablas que los utilizan
